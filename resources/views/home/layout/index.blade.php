...
<html lang="en">
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{asset('fontend/images/588349.png')}}" type="image/x-icon" />
    ...
    <link href="{{asset('fontend/css/colors.css')}}" rel="stylesheet">

    <!-- Version Tech CSS for this template -->
    <link href="{{asset('fontend/css/version/tech.css')}}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{asset('fontend/css/custom.css')}}" type="text/css" rel="stylesheet)}}">
